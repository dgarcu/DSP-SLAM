...
class FrameWithLiDAR:
    ...
    def get_detections(self):
        ...
        depth_order = np.argsort(detections_3d[:, 1])
        detections_3d = detections_3d[depth_order, :]
        for n in range(detections_3d.shape[0]):
            det_3d = detections_3d[n, :]
            obj_class, trans, size, theta = det_3d[0], det_3d[1:4], det_3d[4:7], det_3d[7]
        ...
        bboxes_2d = det_2d["pred_boxes"][:, 1:]
        obj_classes_2d = det_2d["pred_boxes"][:, 0]
